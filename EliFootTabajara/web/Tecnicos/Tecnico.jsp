...
<form method="POST" action="./TecnicoServlet?acao=salvar&id=${tecnico.id}">
    <div class="form-group">
        <label for="nome">Nome</label>
        <input class="form-control" type="text" name="nome" id="nome" value="${tecnico.nome}" onblur="validar();" autofocus required/>
    </div>
    <div class="form-group">
        <input type="hidden" name="id" id="id" ${tecnico.id}/>
